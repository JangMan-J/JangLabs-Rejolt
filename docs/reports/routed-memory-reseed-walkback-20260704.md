...
Numbered F-findings; every one carries the concrete failing input that was demonstrated or traced. Severities: 1 BLOCKER, 3 MAJOR, 8 MINOR, 4 NIT + 2 doc classes.
